...
from finance_team.shared.config import FINANCE_AGENT_NAMES  # noqa: E402
...
def _run_agent(name: str) -> object | None:
    ...
    try:
        ...
        try:
            ...
            publish_report("finance_team", report.agent, report.serialize())
        except Exception:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="WarmPath Finance Team Orchestrator")
