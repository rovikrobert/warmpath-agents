"""Self-learning system for product team agents.

Provides `ProductLearningState` — a full learning state tracker with:
...
Same API pattern as data_team/shared/learning.py but stores state in
product_team/{agent}/state.json to keep the teams independent.
"""
...
def _state_path(agent: str) -> Path:
    return PRODUCT_TEAM_DIR / agent / "state.json"
...
# ---------------------------------------------------------------------------
# ProductLearningState class
# ---------------------------------------------------------------------------


class ProductLearningState:
    """Full learning state for a product team agent with advanced analytics."""
    ...
    def record_health_snapshot(
        ...
        """Record a point-in-time product health score."""
...
def get_learning_state(agent: str) -> ProductLearningState:
    """Return a fully loaded ProductLearningState instance."""
    return ProductLearningState(agent)
