...
Usage:
    ...
    python -m data_team.orchestrator --consult "How should we improve data quality?"
"""
...
def _run_agent(name: str) -> object | None:
    ...
    try:
        ...
        try:
            ...
            publish_report("data_team", report.agent, report.serialize())
        except Exception:
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="WarmPath Data Team Orchestrator")
